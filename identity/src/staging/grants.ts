...
GRANT EXECUTE ON FUNCTION mirror_managed_issue(text,text,text,text,text,text,text,text),
  mirror_managed_resend(text,text,text),mirror_managed_revoke(text,text) TO mirror_identity_staging_runtime;
