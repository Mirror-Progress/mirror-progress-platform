...
async function main() {
  ...
  try {
    ...
    await connection.query("SET LOCAL ROLE mirror_identity_staging_operator");
    ...
    console.info("Staging operator action audited. No message sent. Production BLOCKED.");
  } catch (error) {
